...
dispatch({type: "result", payload: calculator.display})
  ...
  return (
    <section className={styles.buttons}>
      ...
      <span>&divide;</span>
      <span>&times;</span>
      <div onClic={() => numberHandler(7)}>7</div>
      <div onClic={() => numberHandler(8)}>8</div>
      <div onClic={() => numberHandler(9)}>9</div>
      <span>&minus;</span>
      <div onClic={() => numberHandler(4)}>4</div>
      <div onClic={() => numberHandler(5)}>5</div>
      <div onClic={() => numberHandler(6)}>6</div>
      <span>+</span>
      <div onClic={() => numberHandler(1)}>1</div>
      <div onClic={() => numberHandler(2)}>2</div>
      <div onClic={() => numberHandler(3)}>3</div>
      <button className={styles.equal}>=</button>
      <div onClic={() => numberHandler(0o0)}>00</div>
      <div>.</div>
      <div onClic={() => numberHandler(0)}>0</div>
    </section>
  );
}
