...
dispatch({type: "result", payload: calculator.display})
  ...
  return (
    <section className={styles.buttons}>
      ...
      <span>&divide;</span>
      <span>&times;</span>
      <div on={() => numberHandler(7)}>7</div>
      <div on={() => numberHandler(8)}>8</div>
      <div on={() => numberHandler(9)}>9</div>
      <span>&minus;</span>
      <div on={() => numberHandler(4)}>4</div>
      <div on={() => numberHandler(5)}>5</div>
      <div on={() => numberHandler(6)}>6</div>
      <span>+</span>
      <div on={() => numberHandler(1)}>1</div>
      <div on={() => numberHandler(2)}>2</div>
      <div on={() => numberHandler(3)}>3</div>
      <button className={styles.equal}>=</button>
      <div on={() => numberHandler(0o0)}>00</div>
      <div>.</div>
      <div on={() => numberHandler(0)}>0</div>
    </section>
  );
}
